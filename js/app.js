...
var Enemy = function() {
  ...
  Model.call(this,
      -1 * gameDetails.colWidth * Math.floor(Math.random() * 3 + 1),  
              // x: Start on the left for now. Start somewhere off the left side of the canvas to make it appear like the objects are created at different times.
...
Enemy.prototype.detectCollision = function() {
  ...
  if(((enemyX >= playerX && enemyX <= playerEndX) || (enemyEndX > playerX && enemyEndX < playerEndX)) && (this.y == player.y))
    {
